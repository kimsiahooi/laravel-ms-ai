        ...
        return [
            ...
            'purchase-orders' => [
                ...
                'columns' => [
                    ...
                    ['heading' => 'Rate', 'value' => fn (PurchaseOrder $o) => (float) $o->exchange_rate],
                    ...
                    ['heading' => 'Base total', 'value' => fn (PurchaseOrder $o) => (float) $o->items->sum(fn ($i) => (float) $i->quantity * (float) $i->unit_cost) * (float) $o->exchange_rate],
