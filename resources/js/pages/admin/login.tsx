...
const HIGHLIGHTS = [
    ...
    },
    {
        ...
        description: 'Every tenant gets its own dedicated database.',
    },
    {
        icon: ShieldCheck,
            ...
            <aside className="relative hidden flex-col justify-between overflow-hidden bg-zinc-950 p-10 text-zinc-100 lg:flex">
                ...
                <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div className="leading-tight">
                        <p className="font-semibold">MS&#8209;AI Platform</p>
                ...
                <div className="relative z-10 space-y-8">
                    <div className="space-y-3">
                        <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-3 py-1 font-medium text-xs text-zinc-300">
                        ...
                        <p className="max-w-sm text-sm text-zinc-400">
                            ...
                            provision workspaces, manage tenants, and oversee
                            the platform.
                        </p>
                    </div>
                ...
                <p className="relative z-10 text-xs text-zinc-500">
                    &copy; {2026} MS&#8209;AI Platform &middot; Authorized
                    personnel only
                </p>
            </aside>
                ...
                <div className="w-full max-w-sm">
                    ...
                    <Card className="border-border/70 shadow-black/[0.03] shadow-lg">
                        <CardHeader className="space-y-2">
                            ...
                            <CardDescription>
                                Central super&#8209;admin access. Tenant members
                                sign in at their own workspace URL.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <p className="mt-6 flex items-center justify-center gap-1.5 text-center text-muted-foreground text-xs">
                        <Lock className="size-3" />
                        Protected area &middot; access is logged
                    </p>
                </div>
            </main>
        </div>
